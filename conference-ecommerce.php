...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-845565-2']);
...
<body topmargin="10" link="#00AEEF" vlink="#C0C0C0" alink="#00AEEF">
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
		 <tr>
			<td width="100%" colspan="2">
				<div id="logoSAJE"><a href="//www.sajeenaffaires.org/fr/" target="_blank" alt="Logo SAJE acompagnateur d'entrepreneurs" title="SAJE accompagnateur d'entrepreneurs">
				<img border="0" src="../../logos/logo_saje_1985_renv.png" width="300" align="left" vspace="10" hspace="0"></a>

				<div style="background-color:#FFEFC6; width:100px; height:15px; margin-top:15px; margin-right:10px;float:right;position: relative; right:0px"></div>
				<div style="background-color:#FFE28F; width:100px; height:15px; margin-top:35px; margin-right:10px;float:right;position: relative; right:-110px"></div>
				<div style="background-color:#FFCD03; width:100px; height:15px; margin-top:55px; margin-right:10px;float:right;position: relative; right:-220px"></div>
